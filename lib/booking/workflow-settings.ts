...
export type ReservationWorkflowSettings = { mode: BookingMode; paymentExpirationHours: number };
const defaults: ReservationWorkflowSettings = { mode: "manual", paymentExpirationHours: 24 };
