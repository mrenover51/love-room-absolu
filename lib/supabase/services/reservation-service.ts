...
export class ReservationService {
  ...
  async calculatePrice(checkIn:string,checkOut:string,extraKeys:string[]):Promise<PriceBreakdown>{return calculatePriceFromConfig(checkIn,checkOut,extraKeys,await this.pricing.getConfig())}
