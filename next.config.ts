...
const csp = [
  ...
  "img-src 'self' data: blob: https://www.facebook.com https://*.supabase.co https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com",
  "font-src 'self' data:",
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://www.google-analytics.com https://plausible.io https://www.facebook.com https://nominatim.openstreetmap.org",
